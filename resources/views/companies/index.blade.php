            ...
            <tbody>
                ...
                <tr class="bg-gray-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-gray-300">
                        <a href="javascript:void(0)" onclick="toggleBranchesAndWarehouses({{ $company->id }})">{{ $company->name }}</a>
                    </td>
                    <td class="px-6 py-4">
                        @if($company->logo)
                        <img src="{{ asset('storage/' . $company->logo) }}" alt="شعار الشركة" class="w-10 h-10 rounded-full">
                        @endif
                    </td>
                    ...
                    <td class="px-6 py-4 flex space-x-2">
                        <a href="{{ route('companies.edit', $company->id) }}" class="text-blue-600 hover:underline dark:text-blue-500">
    ...
    <td colspan="8" class="p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
        ...
        <table class="w-full text-sm text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-gray-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600">
                    <td class="px-6 py-4">
                        <a href="javascript:void(0)" onclick="toggleBranchWarehouses({{ $branch->id }})">
                            {{ $branch->name }}
                        </a>
                    </td>
                        ...
                        <table class="w-full text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-gray-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">{{ $warehouse->phone_number }}</td>
                                    <td class="px-6 py-4">
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center text-gray-600">لا توجد مستودعات</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
