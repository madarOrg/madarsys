        ...
        <form action="{{ route('warehouse.storage-areas.store', ['warehouse' => $warehouse->id]) }}" method="POST">
            ...
            <div class="space-y-12 dark:bg-gray-900 mb-24">
                <div class="pb-12">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">يرجى إدخال بيانات منطقة التخزين بدقة لضمان
                        تنظيم البيانات.</p>
                    ...
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 min-h-full">
                        ...
                        <div class="col-span-1">
                            <x-file-input id="current-occupancy" name="current_occupancy" label="عدد المنتجات المخزنة"
                                type="number" placeholder="حدد العدد" required
                                value="{{ old('current_occupancy') }}" />
...
@endif
                        ...
                        <!-- شروط التخزين -->
                        <div class="col-span-1">
                            <x-file-input id="storage-conditions" name="storage_conditions" label="شروط التخزين"
                                type="text" placeholder="حدد شروط التخزين" required
