<x-layout dir="rtl">
    ...
    <!-- زر إضافة موقع جديد -->
    <x-button :href="route('warehouses.locations.create', $warehouse)" type="button">
    ...
    <table class="w-full text-sm text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-400 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th class="px-6 py-3">منطقة التخزين</th>
        ...
        <tbody>
            @forelse ($warehouseLocations as $location)
                <tr
                    ...
                    <td class="px-6 py-4">{{$location->storageArea->area_name }}</td>
                    ...
                    <td class="px-6 py-4 flex space-x-2">
                        <!-- رابط تعديل الموقع -->
                        <a href="{{ route('warehouses.locations.edit', ['warehouse' => $warehouse->id, 'warehouse_location' => $location->id]) }}"
                        ...
                        <!-- نموذج حذف الموقع -->
                        <form
                            action="{{ route('warehouses.locations.destroy', ['warehouse' => $warehouse->id, 'warehouse_location' => $location->id]) }}"
    ...
    <x-pagination-links :paginator="$warehouseLocations" />
