<x-layout>
    ...
    <div class="relative mt-1 flex items-center">
        ...
        <form method="GET" action="{{ route('branches.index') }}">
            <x-search-input id="custom-id" name="search" placeholder="ابحث عن الفروع" :value="request()->input('search')" />
        </form>
    </div>
    <!-- زر إضافة فرع جديد -->
    ...
    <x-pagination-links :paginator="$branches" :appends="['search' => request('search')]" />
