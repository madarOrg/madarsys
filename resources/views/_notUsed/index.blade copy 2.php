                ...
                <div class="modal-body">
                    <form id="roleWarehouseForm">
                        ...
                        <div class="form-group">
                            <label for="role_id" class="block text-sm font-medium text-gray-600 dark:text-gray-400">الدور</label>
                        ...
                        <div class="form-group">
                            <label for="branch_id" class="block text-sm font-medium text-gray-600 dark:text-gray-400">الفرع</>
