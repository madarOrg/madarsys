<x-layout>
        ...
        <form action="{{ route('role-permissions.store') }}" method="POST">
            ...
            <div class="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 shadow rounded">
                ...
                <div class="mb-6 grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">الصلاحيات المختارة للدور
                        </h3>
    ...
    <script>
        ...
        function updatePermissionsField() {
            ...
            const permissionsArray = Array.from(selectedPermissions).map(item => item.dataset.id);
            document.getElementById('permissions').value = permissionsArray.join(',');
        }
    </script>
</x-layout>
