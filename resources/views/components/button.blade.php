<button @if($href ?? false) onclick="location.href='{{ $href }}'" @endif
    ...
    class="w-52 h-12 shadow-sm rounded-lg bg-indigo-600 dark:hover:bg-indigo-800 hover:bg-indigo-900  hover:text-gray-200 transition-all duration-700  text-gray-700 dark:text-gray-400 text-base font-semibold leading-7">
