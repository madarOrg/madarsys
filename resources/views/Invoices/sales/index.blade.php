        ...
        <div class="space-y-12 dark:bg-gray-900 ">
            <div class="flex mb-4">
                ...
                <div class="flex space-x-2 rtl:space-x-reverse">
                    <x-button :href="route('invoices.create', ['type' => 'sale'])" class="">
                        <i class="fas fa-plus mr-2"></i> إضافة فاتورة جديدة
                    </x-button>
                    <x-button :href="route('invoices.sales-orders')" class="">
                        <i class="fas fa-clipboard-check mr-2"></i> فواتير من طلبات البيع
                    </x-button>
                </div>
            </div>
