        ...
        <form action="{{ route('invoices.store', ['type' => 'purchase']) }}" method="POST">
            ...
            <div class="space-y-12  dark:bg-gray-900 mb-24">
                ...
                <div class="mt-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 min-h-full">
                    <div class="col-span-1">
                        <x-file-input id="invoice_Code" value="{{ request('invoice_code') ?? '' }}" name="invoice_Code" readonly label="رقم الفاتورة"   />
                        @error('invoice_Code')
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <input type="text" id="discount_value" name="discount_value" value="0" class="w-full bg-gray-100 rounded border border-b dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out dark:focus:bg-gray-700 focus:outline-blue-500 dark:focus:text-gray-200 mt-1"
                ...
                <div class="mt-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 min-h-full">
                    <!-- Discount Amount -->
                    <div class="col-span-1">
                        <x-file-input id="discount_amount" name="discount_amount" value="0" readonly label="مبلغ الخصم" />
                    ...
                    <!-- Total Price -->
                    <div class="col-span-1">
                        <x-file-input id="total_price" name="total_price" value="0" readonly label="المجموع الكلي" />
                        @error('total_price')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
