                                ...
                                <td class="py-2 px-4  text-center">{{ $salesOrder->order_number }}</td>
                                    ...
                                    <td class="py-2 px-4 ">
                                        <div class="flex justify-center space-x-1 space-x-reverse">
                                            ...
                                            <a href="{{ route('invoices.create-from-sales-order', $salesOrder->id) }}" class="bg-green-200 text-gray-600 px-2 py-1 rounded hover:bg-green-600">
                                                <i class="fas fa-file-invoice"></i> إنشاء فاتورة
                                            </a>
                                            
                                            <a href="{{ route('sales-orders.print', $salesOrder->id) }}" class="text-gray-600 px-2 py-1 rounded " target="_blank">
