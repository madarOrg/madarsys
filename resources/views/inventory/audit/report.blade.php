            ...
            <tbody>
                @forelse($products as $product)
                    <tr>
                        ...
                        <td class="border p-2 w-auto min-w-[50px] whitespace-nowrap">{{ $product->inventory->quantity ?? 0 }}</td>
                        <td class="border p-2 w-auto min-w-[50px] whitespace-nowrap">{{ $product->last_inventory_date ? $product->last_inventory_date->format('Y-m-d') : 'غير متوفر' }}
                        </td>
                        <td class="border p-2 w-auto min-w-[50px] whitespace-nowrap">{{ $product->status }}</td>
                        <td class="border p-2 w-auto min-w-[50px] whitespace-nowrap">{{ $product->inventoryTransactions->sum('quantity') }}</td>
                    </tr>
                @empty
                    <tr>
