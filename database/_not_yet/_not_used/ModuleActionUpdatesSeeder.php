...
class ModuleActionUpdatesSeeder extends Seeder
{


    public function run()
    {
        // جلب جميع الوحدات من جدول modules
        $modules = Module::all();

        // مصفوفة تحتوي على بيانات روابط النافبار مع الأيقونات
        $navbarLinks = [
            [
       ...
       // تحديث سجلات ModuleAction بناءً على الـ navbarLinks
    ...
    public function extractActionKey($href)
    {
