...
class ModuleActionsSeeder extends Seeder {
    ...
    public function run()
    {
        $menus = [
            ...
            ['id' => 61, 'module_id' => 5, 'name' => 'إنشاء فواتير المبيعات', 'action_key' => 'sales', 'route' => '/invoices/sales', 'icon' => 'fa fa-receipt text-yellow-500', 'created_at' => Carbon::parse('2025-01-31 16:30:35'), 'updated_at' => Carbon::parse('2025-02-01 16:08:19'), 'branch_id' => 2],
            ['id' => 62, 'module_id' => 5, 'name' => 'إنشاء فواتير المشتريات', 'action_key' => 'purchases', 'route' => '/invoices/purchases', 'icon' => 'fa fa-shopping-cart text-green-500', 'created_at' => Carbon::parse('2025-01-31 16:30:35'), 'updated_at' => Carbon::parse('2025-02-01 16:08:19'), 'branch_id' => 2],
